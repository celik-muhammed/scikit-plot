...
.. glossary::
    ...
    API
        ...
        largely documented in. However, we less formally consider
    ...
    cloned
        ...
        might yield different results from the original estimator.
    ...
    examples
        ...
        * as examples in the
          ...
          User Guide.
        * sometimes in the (built from ``doc/``)
    ...
    narrative documentation
        An alias for , i.e. documentation written
        in ``doc/modules/``. the User Guide aims to:
    ...
    SLEPs
        ...
        versions happen via a and follows the
...
.. glossary::
    ...
    density estimator
        ...
        * kernel_density - uses a kernel function, controlled by the
...
.. glossary::
    ...
    cross-validation generator
        ...
        sequence of train and test portions,
    ...
    cross-validation estimator
        ...
        automatically select the best hyper-parameters. Some example of cross-validation estimators
        ...
        :term:`estimator` class along with is
...
.. glossary::
    ...
    ``cv``
        ...
        - A :term:`cross-validation splitter` instance. Refer to the
          for splitters available within Scikit-learn.
    ...
    ``kernel``
        ...
        or a callable kernel function used to compute the kernel matrix.
    ...
    ``random_state``
        ...
        objects and avoid common pitfalls.
    ...
    ``scoring``
        ...
        estimator's :term:`score` method is used.
    ...
    ``warm_start``
        ...
        performance as in), it may be possible
...
.. glossary::
    ...
    ``embedding_``
        An embedding of the training data in estimators, with shape ``(n_samples, n_components)``,
