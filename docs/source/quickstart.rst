.. Quickstart file describing a quick plot with scikit-plots
...
First steps with scikit-plots
=============================

Eager to use scikit-plots? Let's get started! This section of the documentation will teach you the basic philosophy behind scikit-plots by running you through a quick example.

Installation
------------

Before anything else, make sure you've installed the latest version of scikit-plots. Scikit-plots is on PyPi, so simply run::

    $ pip install scikit-plots

to install the latest version.

Alternatively, you can clone the `source repository <https://github.com/celik-muhammed/scikit-plot/tree/muhammed-dev>`_ and run::
